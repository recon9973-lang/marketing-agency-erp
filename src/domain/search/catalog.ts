...
const PAGES: CatalogItem[] = [
  ...
  { id: "p-convert", kind: "page", title: "이미지 변환", href: "/studio/convert", roles: ALL, keywords: "이미지 변환 webp 압축 최적화 리사이즈 png jpg convert optimize resize 용량 줄이기 일괄", description: "PNG·JPG·WEBP 변환·압축·리사이즈·일괄 ZIP" },
  ...
  { id: "p-leave", kind: "page", title: "연차/휴가", href: "/leave", roles: ALL, keywords: "연차 휴가 leave 반차 신청 잔여", description: "연차·휴가 신청·현황" },
  { id: "p-weekly", kind: "page", title: "주간보고", href: "/weekly", roles: ALL, keywords: "주간 주간보고 weekly 보고", description: "주간 업무 보고" },
...
const HELP: CatalogItem[] = [
  ...
  { id: "h-leave", kind: "help", title: "연차/휴가 신청", href: "/leave", roles: ALL, keywords: "연차 휴가 반차 신청 잔여 일수 승인", description: "연차/휴가에서 기간을 선택해 신청하면 관리자 승인으로 반영됩니다." },
  { id: "h-weekly", kind: "help", title: "주간보고 작성", href: "/weekly", roles: ALL, keywords: "주간 보고 작성 제출 이번주", description: "주간보고에서 이번 주 업무를 정리해 제출합니다." },
