...
export function getIntegrationStatuses(): IntegrationStatus[] {
  return [
    ...
    },
    {
      ...
      configured: true,
      envVars: [],
      description: "행안부 주민등록(인구·성별·증감) + 심평원 병원정보(밀집도·좌표)·상병통계·한방 지역 진료통계를 내장 데이터셋으로 실측 (키 불필요)",
    ...
    },
    {
      ...
      category: "데이터·광고",
      configured: hasAny("NAVER_CLIENT_ID", "NAVER_SEARCH_CLIENT_ID") && hasAny("NAVER_CLIENT_SECRET", "NAVER_SEARCH_CLIENT_SECRET"),
