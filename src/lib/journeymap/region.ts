...
const REGION_WORDS = new Set([
  ...
  "동탄", "수지", "해운대", "서면", "수성", "달서",
  // 전국 주요 시 (접미사 없는 표기 — "창원시" 류는 SUFFIX_RE 가 처리)
  "수원", "성남", "용인", "고양", "부천", "안산", "안양", "화성", "평택",
  "시흥", "김포", "파주", "의정부", "남양주", "하남", "광명", "군포", "이천",
  "춘천", "원주", "강릉", "속초", "동해",
  "천안", "아산", "청주", "충주", "제천", "당진", "서산",
  "전주", "익산", "군산", "정읍", "여수", "순천", "목포", "광양", "나주",
  "포항", "구미", "경산", "안동", "경주", "김천", "영주",
  "창원", "마산", "진해", "김해", "양산", "진주", "거제", "통영", "사천", "밀양",
  "제주시", "서귀포",
]);
