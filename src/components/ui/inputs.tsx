...
// 기존 화면의 `mt-1 w-full rounded-md border border-line px-3 py-2` 스타일을 기준으로 공통화.
import type { ComponentProps, ReactNode } from "react";

const fieldBase =
  "w-full rounded-md border border-line bg-white px-3 py-2 text-sm text-ink placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand disabled:bg-surface disabled:opacity-70";
